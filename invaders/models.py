...
class Bolt(GRectangle):
    ...
    def __init__(self, x, y, vel):
        ...
        width = BOLT_WIDTH, height = BOLT_HEIGHT, fillcolor = 'yellow',
    ...
    def isPlayerBolt(self):
        """
        Returns True if the bolt is one fired by a player. Returns False otherwise.
        """
